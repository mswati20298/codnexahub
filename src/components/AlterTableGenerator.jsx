  ...
  return (
    <div>
      <div className="grid sm:grid-cols-2 gap-4 mb-4">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-300">
          Action
          <select value={action} onChange={(e) => setAction(e.target.value)} className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-slate-900 dark:text-slate-100">
      ...
      <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-300 mb-4">
        ...
        <input value={colDef} onChange={(e) => setColDef(e.target.value)} className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-slate-900 dark:text-slate-100 font-mono text-sm" />
      </label>
