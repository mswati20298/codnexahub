...
const STATUS_STYLES = {
  operational: "text-emerald-400 border-emerald-900 bg-emerald-950/40",
  degraded: "text-amber-400 border-amber-900 bg-amber-950/40",
  major: "text-red-400 border-red-900 bg-red-950/40",
  minor: "text-amber-400 border-amber-900 bg-amber-950/40",
...
export default function ModelStatusTracker() {
  ...
  return (
    <div>
      ...
      {loading && !data && <p className="text-slate-500 text-sm">Loading status...</p>}
