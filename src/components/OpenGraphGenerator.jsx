  ...
  return (
    <div>
      <div className="space-y-4 mb-4">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-300">
          Page URL
          <input value={url} onChange={(e) => setUrl(e.target.value)} className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-slate-900 dark:text-slate-100" />
        </label>
      </div>
