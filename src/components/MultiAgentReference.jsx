...
export default function MultiAgentReference() {
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-slate-500">More agents and steps mean more cost and latency — start with the simplest pattern that solves the problem before reaching for complex multi-agent orchestration.</p>
    </div>
  );
}
