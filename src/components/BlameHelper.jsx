...
export default function BlameHelper() {
  ...
  return (
    <div className="space-y-1">
      ...
      <p className="text-xs text-slate-500 mt-4">--ignore-rev is useful after a large reformatting commit — it skips that commit and attributes lines to whoever changed them before the reformat.</p>
    </div>
  );
}
