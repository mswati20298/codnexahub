  ...
  return (
    <div>
      <div className="grid sm:grid-cols-2 gap-4 mb-6">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-300">
          Selling price ($)
          <input type="number" min="0" value={sellingPrice} onChange={(e) => setSellingPrice(Number(e.target.value) || 0)} className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-100" />
        </label>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-3">
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
          ...
          <p className="text-xl font-semibold text-indigo-400">${results.profit.toFixed(2)}</p>
        </div>
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
          ...
          <p className="text-xl font-semibold text-slate-100">{results.markupPct.toFixed(1)}%</p>
        </div>
      </div>
