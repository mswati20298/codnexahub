...
export default function SvgOptimizer() {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-slate-500 mt-4">Removes comments, extra whitespace, and IDs — a lightweight cleanup, not a full optimizer like SVGO (doesn't merge paths or simplify geometry).</p>
    </div>
  );
}
