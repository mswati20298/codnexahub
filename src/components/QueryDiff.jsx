  ...
  return (
    <div>
      <div className="grid sm:grid-cols-2 gap-4 mb-4">
        <textarea value={a} onChange={(e) => setA(e.target.value)} rows={7} className="w-full bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-100 font-mono text-xs" />
        <textarea value={b} onChange={(e) => setB(e.target.value)} rows={7} className="w-full bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-100 font-mono text-xs" />
      </div>
