...
export default function CherryPickHelper() {
  ...
  return (
    <div className="space-y-1">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-500 mt-4">Cherry-picking creates a new commit with a different hash — useful for applying a specific fix to another branch without merging everything.</p>
    </div>
  );
}
