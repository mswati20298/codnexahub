  ...
  return (
    <div>
      <div className="grid sm:grid-cols-2 gap-4 mb-6">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-300">
          Markup (%)
          <input type="number" min="0" value={markupPct} onChange={(e) => setMarkupPct(Number(e.target.value) || 0)} className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-slate-900 dark:text-slate-100" />
        </label>
      </div>
      <div className="grid sm:grid-cols-3 gap-3">
        <div className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg p-4">
          ...
          <p className="text-xl font-semibold text-emerald-600 dark:text-emerald-400">₹{results.sellingPrice.toFixed(2)}</p>
        </div>
        <div className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg p-4">
        ...
        <div className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg p-4">
          <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Equivalent margin</p>
