            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4 mb-12">
              {displayTools.map((tool) => (
                <a
                  key={tool.href}
                  href={tool.href}
                  className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 hover:border-emerald-400 dark:hover:border-emerald-600 hover:shadow-md transition-all"
                >
