...
export default function SlugGenerator() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-4">
        <label className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <select
            ...
            className="bg-slate-800 border border-slate-700 rounded-lg px-2 py-1 text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
      ...
      <div
        onClick={handleCopy}
        className="cursor-pointer bg-slate-800 border border-slate-700 rounded-lg px-3 py-3 hover:border-indigo-500 flex justify-between items-center"
      >
        <span className="font-mono text-sm text-indigo-400 break-all">{slug}</span>
