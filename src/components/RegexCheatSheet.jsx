        ...
        <div key={group.category}>
          ...
          <div className="space-y-1">
            {group.items.map((item) => (
              <div key={item.token} className="flex gap-3 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm">
                <code className="text-indigo-400 w-20 shrink-0">{item.token}</code>
