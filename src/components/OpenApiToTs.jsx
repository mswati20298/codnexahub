...
export default function OpenApiToTs() {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-slate-500 dark:text-slate-500 mt-4">Reads schemas from components.schemas — handles basic types and arrays, not $ref references or oneOf/allOf compositions.</p>
    </div>
  );
}
