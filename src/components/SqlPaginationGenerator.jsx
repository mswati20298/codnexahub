  ...
  return (
    <div>
      <div className="grid sm:grid-cols-2 gap-4 mb-4">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-300">
          Dialect
          <select value={dialect} onChange={(e) => setDialect(e.target.value)} className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-100">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-300">
          Page number
          <input type="number" min="1" value={page} onChange={(e) => setPage(Number(e.target.value) || 1)} className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-100" />
        </label>
      </div>
