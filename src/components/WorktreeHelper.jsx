...
export default function WorktreeHelper() {
  ...
  return (
    <div className="space-y-1">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-500 mt-4">Worktrees let you check out multiple branches simultaneously in separate folders, sharing the same repository — useful for working on a hotfix without stashing your current feature work.</p>
    </div>
  );
}
