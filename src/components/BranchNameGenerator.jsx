  ...
  return (
    <div>
      <div className="grid sm:grid-cols-3 gap-4 mb-4">
        ...
        <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-300">
          Ticket ID (optional)
          <input type="text" value={ticket} onChange={(e) => setTicket(e.target.value)} className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-slate-900 dark:text-slate-100" />
        </label>
        <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-300 sm:col-span-1">
          Description
          <input type="text" value={description} onChange={(e) => setDescription(e.target.value)} className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-slate-900 dark:text-slate-100" />
        </label>
      </div>
      ...
      <div onClick={copy} className="cursor-pointer bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-4 py-3 hover:border-emerald-500 flex justify-between items-center">
        <span className="font-mono text-emerald-600 dark:text-emerald-400 break-all">{branchName}</span>
