...
export default function DeleteGenerator() {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-red-600 dark:text-red-400 mt-4">A DELETE without a WHERE clause removes every row in the table. Always test with a SELECT using the same WHERE first.</p>
    </div>
  );
}
