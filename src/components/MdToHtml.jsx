  ...
  return (
    <div>
      ...
      <div className="flex justify-end mb-2">
        <button onClick={copy} className="text-xs px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 hover:border-emerald-500 text-slate-700 dark:text-slate-300">Copy HTML</button>
      </div>
      ...
      <p className="text-xs text-slate-500 dark:text-slate-500 mt-4">Handles headers, bold/italic, inline code, links, and simple lists — not tables, nested lists, or blockquotes.</p>
    </div>
  );
}
