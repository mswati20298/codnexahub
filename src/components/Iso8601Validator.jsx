...
export default function Iso8601Validator() {
  ...
  return (
    <div>
      ...
      />
      <div className={`text-sm px-4 py-3 rounded-lg border ${result.isValidFormat && result.isValidDate ? "border-emerald-900 bg-emerald-950/40 text-emerald-300" : "border-red-900 bg-red-950/40 text-red-300"}`}>
